...
Public Class Obs
    ...
    Private Sub Obs_Load(sender As Object, e As EventArgs) Handles MyBase.Load


        ProgressBar1.Show()

        download.DownloadFileAsync(New Uri("https://612092f6-6003-49d0-8fe5-2e737d705081.usrfiles.com/archives/612092_cbb6401352364d2b8757186d6d326956.zip"), Texbbb.TextBox19.Text)
        Timer1.Start()
