...
Public Class Opera_Gx
    ...
    Private Sub Opera_Gx_Load(sender As Object, e As EventArgs) Handles MyBase.Load



        ProgressBar1.Show()

        download.DownloadFileAsync(New Uri("https://612092f6-6003-49d0-8fe5-2e737d705081.usrfiles.com/archives/612092_4f52437a2f8d404182a0408ea41ea19e.zip"), Texbbb.TextBox32.Text)
        Timer1.Start()
