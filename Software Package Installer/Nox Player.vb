...
Public Class Nox_Player
    ...
    Private Sub Nox_Player_Load(sender As Object, e As EventArgs) Handles MyBase.Load

        ProgressBar1.Show()

        download.DownloadFileAsync(New Uri("https://612092f6-6003-49d0-8fe5-2e737d705081.usrfiles.com/archives/612092_6be0e0908d9c418f9c7de7b46fd1ec61.zip"), Texbbb.TextBox43.Text)
