...
Public Class Itop_Vpn
    ...
    End Sub
    Private Sub Itop_Vpn_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        download.DownloadFileAsync(New Uri("https://612092f6-6003-49d0-8fe5-2e737d705081.usrfiles.com/archives/612092_51d67425df2e4cd3bb06250dbbe9d26e.zip"), Texbbb.TextBox61.Text)
    ...
    Private Sub Timer2_Tick(sender As Object, e As EventArgs) Handles Timer112.Tick
