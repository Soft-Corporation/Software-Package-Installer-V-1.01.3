...
Public Class Edge_Beta
    ...
    Private Sub Edge_Beta_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ProgressBar1.Show()

        download.DownloadFileAsync(New Uri("https://612092f6-6003-49d0-8fe5-2e737d705081.usrfiles.com/archives/612092_3869dec2418441edb264dc0c68ecb514.zip"), Texbbb.TextBox80.Text)
