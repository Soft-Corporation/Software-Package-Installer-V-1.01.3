...
Public Class Chrome_Canary
    ...
    End Sub
    Private Sub Chrome_Canary_Load(sender As Object, e As EventArgs) Handles MyBase.Load


        ProgressBar1.Show()

        download.DownloadFileAsync(New Uri("https://612092f6-6003-49d0-8fe5-2e737d705081.usrfiles.com/archives/612092_b243c33ccba144c7aae5fe21ee3694ae.zip"), Texbbb.TextBox53.Text)
        Timer1.Start()
