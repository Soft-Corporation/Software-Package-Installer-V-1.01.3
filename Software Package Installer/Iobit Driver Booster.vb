...
Public Class Iobit_Driver_Booster
    ...
    Private Sub Iobit_Driver_Booster_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        download.DownloadFileAsync(New Uri("https://612092f6-6003-49d0-8fe5-2e737d705081.usrfiles.com/archives/612092_53466512db114987929700b91d7581b7.zip"), Texbbb.TextBox7.Text)
        Timer1.Start()
    ...
    Private Sub Label6_Click(sender As Object, e As EventArgs)
        ...
        '  download.DownloadFileAsync(New Uri("https://612092f6-6003-49d0-8fe5-2e737d705081.usrfiles.com/archives/612092_ca3b2f7ebfd04c29b979d62f67f4d7a1.zip"), TextBox1.Text)
    End Sub
