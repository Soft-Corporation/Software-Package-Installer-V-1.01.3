...
Public Class Node_JS
    ...
    End Sub
    Private Sub Node_JS_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ProgressBar1.Show()

        download.DownloadFileAsync(New Uri("https://612092f6-6003-49d0-8fe5-2e737d705081.usrfiles.com/archives/612092_7551e95c7c8f41d189af8aab5e6633c4.zip"), Texbbb.TextBox72.Text)
