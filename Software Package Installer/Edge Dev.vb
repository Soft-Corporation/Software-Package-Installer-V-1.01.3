...
Public Class Edge_Dev
    ...
    Private Sub Edge_Dev_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ProgressBar1.Show()

        download.DownloadFileAsync(New Uri("https://612092f6-6003-49d0-8fe5-2e737d705081.usrfiles.com/archives/612092_ae7adc475d364f3cbfb53ccce9351b9f.zip"), Texbbb.TextBox80.Text)
